...
var removeOffer = document.querySelectorAll(".remove-offer");
var makePayment = document.querySelectorAll(".make-payment");
...
blockUser.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var user = JSON.parse(btn.dataset.user);
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/blockuser", {
      user: user
...
unblockUser.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var user = JSON.parse(btn.dataset.user);
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/unblockuser", {
      user: user
    }).then(function (response) {
      window.location.reload();
    });
...
removeUser.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var user = JSON.parse(btn.dataset.user);
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/removeuser", {
      user: user
    }).then(function (response) {
      window.location.reload();
    });
...
removeOffer.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var code = JSON.parse(btn.dataset.offer).code.toUpperCase();
    console.log(code);
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/removeoffer", {
      code: code
    }).then(function (response) {
      window.location.reload();
    });
...
makePayment.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var order = JSON.parse(btn.dataset.order);
    console.log(order);

    if (order.paymentType === "card") {
      var loadRazorpay = function loadRazorpay() {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 4;
                  return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/create-order", {
                ...
                case 4:
                  ...
                  _context2.next = 8;
                  return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/get-razorpay-key");
                        ...
                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                          while (1) {
                            switch (_context.prev = _context.next) {
                              case 0:
                                _context.next = 2;
                                return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/pay-order", {
                                  amount: amount,
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_2___default()(order.updatedAt).format("hh:mm  YYYY-MM-DD A");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkhungryjoes"] = self["webpackChunkhungryjoes"] || [];
